---
title: "Exploring Toronto Restaurant Scene"
output: 
  html_document:
    toc: true
    toc_depth: 4
...
For this project, we have focused our attention on the Yelp dataset, found [here](https://www.yelp.com/dataset "Yelp Dataset"). After careful consideration of multiple dataset, we concluded that certain ones, such as Citibike or the Million Songs dataset have been overly analyzed and dissected, thereby limiting the vlaue we could add. During our search for more low-key datasets, we eventually came across the Yelp dataset. We decided to dive deeper into the dataset in the hope of discovering interesting insights and patterns for several reasons:
